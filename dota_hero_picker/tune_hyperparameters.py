...
def create_objective(
    ...
    def objective(trial: Trial) -> float:
        ...
        all_options = [8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096]
        layer_sizes = []
        ...
        for train_idx, val_idx in skf.split(
            ...
            model, best_val_loss, best_val_f1 = train_model(
                model,
                training_arguments,
            )
            folds_val_f1.append(best_val_f1)
            folds_val_loss.append(best_val_loss)
